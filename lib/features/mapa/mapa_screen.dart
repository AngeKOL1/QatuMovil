...
// // Después — centro aproximado de toda Cajamarca ciudad
// const _mercadoLat = -7.1617;
// const _mercadoLng = -78.5127;
...
//       setState(() {
//         if (!evento.visible) {
//           // Vendedor se puso inactivo → remover del mapa
//           _vendedores.remove(evento.vendedorId);
//         } else {
//           // Actualizar o agregar vendedor
...
//             options: MapOptions(
//               initialCenter: const LatLng(_mercadoLat, _mercadoLng),
//               initialZoom: 14.0,
//               minZoom: 11,
//               maxZoom: 19,
//             ),
...
//           // Barra superior con logo y logout
//           Positioned(
//             top: 0,
//             left: 0,
//             right: 0,
...
//           // Filtros de categoría (barra inferior)
//           Positioned(
//             bottom: 24,
//             left: 0,
//             right: 0,
...
//       // FAB para centrar en el mercado
